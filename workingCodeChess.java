...
class ChessBoard extends JPanel {
	...
	private int sizeSquares, squareX = 0, squareY = 0;
	...
	// For determining if pawn already moved twice
	...
	public boolean isValid(String tempPath) {
		...
		if (tempPath.equals("wP.png")) {
			...
			if (pieces[currentRowSelected][currentColSelected] != null) {
				moveValid = false;
				return moveValid;
			}
	...
	public void paintComponent(Graphics g) {
		...
		// Set the pieces up for the first time
		if (setPiecesBegin == false) {
